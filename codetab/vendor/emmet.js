var EmmetLib = (() => {
  ...
  __export(emmet_es_exports, {
    CSSAbbreviationScope: () => CSSAbbreviationScope,
    default: () => expandAbbreviation,
    extract: () => extractAbbreviation,
    markup: () => markup,
    markupAbbreviation: () => parseAbbreviation,
    parseMarkup: () => parse$1,
    parseStylesheet: () => parse,
    parseStylesheetSnippets: () => convertSnippets,
    resolveConfig: () => resolveConfig,
    stringifyMarkup: () => stringify,
    stringifyStylesheet: () => css,
    stylesheet: () => stylesheet,
    stylesheetAbbreviation: () => parse$2
  });
